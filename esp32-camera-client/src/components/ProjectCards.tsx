...
import { ShoppingCart, CreditCard, Shield, Settings, Globe, MessageSquare, ExternalLink } from 'lucide-react';
        ...
        {projects.map((project) => {
          ...
          return (
            <div key={project.id} className="card group hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-sm text-primary-500 font-semibold mb-2">{project.company}</p>
