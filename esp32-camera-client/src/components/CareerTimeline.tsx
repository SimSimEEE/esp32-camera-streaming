              ...
              >
                ...
                >
                  <div className="card group hover:shadow-xl hover:shadow-primary-900/20">
                    {/* Phase Badge */}
                    <div className="mb-4">
                      <span className={`inline-block px-3 py-1 bg-gradient-to-r ${milestone.color} text-white text-xs font-bold rounded-full`}>
                        {milestone.phase}
                      </span>
                    </div>

                    {/* Period */}
                    <p className="text-sm text-gray-500 mb-2">{milestone.period}</p>

                    {/* Title & Company */}
                    <h3 className="text-2xl font-bold mb-2 text-white group-hover:text-primary-400 transition-colors">
                      {milestone.title}
                    </h3>
                    <p className="text-primary-400 font-semibold mb-3">{milestone.company}</p>
