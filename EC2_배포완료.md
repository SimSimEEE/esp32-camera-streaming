...
**파일:** `esp32-camera-firmware/ESP32_Camera_Stream/Config.h`
...
// WebSocket 서버 설정
#define WS_HOST "52.79.241.244"  // ← EC2 공인 IP
#define WS_PORT 8887
...
```
┌─────────────┐
│  ESP32-CAM  │ ──ws://52.79.241.244:8887/esp32──┐
└─────────────┘                                   │
                                                  ▼
┌─────────────┐                          ┌─────────────────┐
│   Browser   │ ─http://52.79.241.244──▶ │   EC2 Instance  │
└─────────────┘                          │  52.79.241.244  │
        │                                │                 │
        │                                │  ┌────────────┐ │
        └───ws://.../ws/viewer──────────▶│  │   nginx    │ │
...
4. Java 서버 로그에서 ESP32 연결 시도 확인

## 📖 관련 문서

- [배포 가이드](DEPLOY_GUIDE.md) - 전체 배포 프로세스
- [배포 준비](배포준비완료.md) - 사전 준비 사항
- [README](README.md) - 프로젝트 개요

## 🎯 다음 단계

- [ ] EC2 보안 그룹 설정 확인
- [ ] http://52.79.241.244/ 접속 테스트
- [ ] ESP32 Config.h 업데이트
- [ ] ESP32 펌웨어 업로드
- [ ] 전체 시스템 테스트
...
**배포 완료:** 2025-02-18  
**EC2 인스턴스:** i-0c0ae63bb9931b3ed (52.79.241.244)  
